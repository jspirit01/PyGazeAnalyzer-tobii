...
for ppname in PPS:
	...
	# path
	# asc가 있으면 바로 열고, asc없이 edf만 있으면 edf2asc 실행파일을 이요하여 asc로 변환하는 코드.
	...
	edfdata = read_tobii(os.path.join(DATADIR, '%s_TOBII_output.tsv' % ppname), EDFSTART, stop=EDFSTOP)
